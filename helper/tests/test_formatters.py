...
def test_ok_payload_display_shape() -> None:
    now = datetime.fromisoformat("2026-05-22T12:41:00+02:00")
    reset_at = datetime.fromisoformat("2026-05-22T14:35:00+02:00")
...
def test_ok_payload_compact_display_omits_labels() -> None:
    now = datetime.fromisoformat("2026-05-22T12:41:00+02:00")
    reset_at = datetime.fromisoformat("2026-05-22T14:35:00+02:00")
...
def test_build_display_hides_weekly_limits_when_disabled() -> None:
    now = datetime.fromisoformat("2026-05-22T12:41:00+02:00")
    reset_at = datetime.fromisoformat("2026-05-22T14:35:00+02:00")
